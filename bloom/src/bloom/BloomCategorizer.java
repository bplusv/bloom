...
public class BloomCategorizer {
    ...
    public static Map<Integer, Integer> Categorize(Map<String, Integer> input) {
        ...
        _output.put(4, 0); // Evaluation
        _output.put(5, 0); // Creation
        ...
        _bloomTaxonomy[4] = new ArrayList<String>(); // evaluation
        _bloomTaxonomy[4].add("apoyar");
        _bloomTaxonomy[4].add("argumentar");
        _bloomTaxonomy[4].add("ayudar");
        _bloomTaxonomy[4].add("calcular");
        _bloomTaxonomy[4].add("comparar");
        _bloomTaxonomy[4].add("concluir");
        _bloomTaxonomy[4].add("constatar");
        _bloomTaxonomy[4].add("contrastar");
        _bloomTaxonomy[4].add("convencer");
        _bloomTaxonomy[4].add("corregir");
        _bloomTaxonomy[4].add("criticar");
        _bloomTaxonomy[4].add("decidir");
        _bloomTaxonomy[4].add("defender");
        _bloomTaxonomy[4].add("definir");
        _bloomTaxonomy[4].add("descubrir");
        _bloomTaxonomy[4].add("determinar");
        _bloomTaxonomy[4].add("discriminar");
        _bloomTaxonomy[4].add("distribuir");
        _bloomTaxonomy[4].add("enjuiciar");
        _bloomTaxonomy[4].add("escoger");
        _bloomTaxonomy[4].add("establecer");
        _bloomTaxonomy[4].add("estimar");
        _bloomTaxonomy[4].add("evaluar");
        _bloomTaxonomy[4].add("explicar");
        _bloomTaxonomy[4].add("interpretar");
        _bloomTaxonomy[4].add("justificar");
        _bloomTaxonomy[4].add("juzgar");
        _bloomTaxonomy[4].add("medir");
        _bloomTaxonomy[4].add("ponderar");
        _bloomTaxonomy[4].add("predecir");
        _bloomTaxonomy[4].add("probar");
        _bloomTaxonomy[4].add("promediar");
        _bloomTaxonomy[4].add("recomendar");
        _bloomTaxonomy[4].add("relacionar");
        _bloomTaxonomy[4].add("revisar");
        _bloomTaxonomy[4].add("seleccionar");
        _bloomTaxonomy[4].add("sustentar");
        _bloomTaxonomy[4].add("tasar");
        _bloomTaxonomy[4].add("validar");
        _bloomTaxonomy[4].add("valorar");
        _bloomTaxonomy[4].add("valorizar");
        _bloomTaxonomy[4].add("valuar");
        _bloomTaxonomy[4].add("verificar");
        _bloomTaxonomy[4].add("construir");
        _bloomTaxonomy[4].add("diseñar");
        _bloomTaxonomy[4].add("elaborar");
        _bloomTaxonomy[4].add("idear");
        _bloomTaxonomy[4].add("trazar");
        _bloomTaxonomy[4].add("planear");
        _bloomTaxonomy[4].add("producir");
        
        
        _bloomTaxonomy[5] = new ArrayList<String>(); // synthesis
        _bloomTaxonomy[5].add("acomodar");
        _bloomTaxonomy[5].add("adaptar");
        _bloomTaxonomy[5].add("animar");
        _bloomTaxonomy[5].add("anticipar");
        _bloomTaxonomy[5].add("apoyar");
        _bloomTaxonomy[5].add("aprestar");
        _bloomTaxonomy[5].add("arreglar");
        _bloomTaxonomy[5].add("categorizar");
        _bloomTaxonomy[5].add("codificar");
        _bloomTaxonomy[5].add("coleccionar");
        _bloomTaxonomy[5].add("combinar");
        _bloomTaxonomy[5].add("comparar");
        _bloomTaxonomy[5].add("compilar");
        _bloomTaxonomy[5].add("componer");
        _bloomTaxonomy[5].add("comunicar");
        _bloomTaxonomy[5].add("construir");
        _bloomTaxonomy[5].add("contrastar");
        _bloomTaxonomy[5].add("corresponder");
        _bloomTaxonomy[5].add("crear");
        _bloomTaxonomy[5].add("cultivar");
        _bloomTaxonomy[5].add("describir");
        _bloomTaxonomy[5].add("depurar");
        _bloomTaxonomy[5].add("desarrollar");
        _bloomTaxonomy[5].add("dirigir");
        _bloomTaxonomy[5].add("diseñar");
        _bloomTaxonomy[5].add("elaborar");
        _bloomTaxonomy[5].add("ensamblar");
        _bloomTaxonomy[5].add("erigir");
        _bloomTaxonomy[5].add("escribir");
        _bloomTaxonomy[5].add("estructurar");
        _bloomTaxonomy[5].add("explicar");
        _bloomTaxonomy[5].add("expresar");
        _bloomTaxonomy[5].add("facilitar");
        _bloomTaxonomy[5].add("formular");
        _bloomTaxonomy[5].add("generar");
        _bloomTaxonomy[5].add("idear");
        _bloomTaxonomy[5].add("incorporar");
        _bloomTaxonomy[5].add("iniciar");
        _bloomTaxonomy[5].add("integrar");
        _bloomTaxonomy[5].add("inventar");
        _bloomTaxonomy[5].add("manejar");
        _bloomTaxonomy[5].add("modelar");
        _bloomTaxonomy[5].add("modificar");
        _bloomTaxonomy[5].add("mejorar");
        _bloomTaxonomy[5].add("montar");
        _bloomTaxonomy[5].add("narrar");
        _bloomTaxonomy[5].add("ordenar");
        _bloomTaxonomy[5].add("organizar");
        _bloomTaxonomy[5].add("planear");
        _bloomTaxonomy[5].add("plantear");
        _bloomTaxonomy[5].add("preparar");
        _bloomTaxonomy[5].add("proponer");
        _bloomTaxonomy[5].add("proyectar");
        _bloomTaxonomy[5].add("recabar");
        _bloomTaxonomy[5].add("reconstruir");
        _bloomTaxonomy[5].add("recopilar");
        _bloomTaxonomy[5].add("redactar");
        _bloomTaxonomy[5].add("reforzar");
        _bloomTaxonomy[5].add("relacionar");
        _bloomTaxonomy[5].add("reorganizar");
        _bloomTaxonomy[5].add("revisar");
        _bloomTaxonomy[5].add("sustituir");
        _bloomTaxonomy[5].add("reunir");
        _bloomTaxonomy[5].add("sustituir");
        _bloomTaxonomy[5].add("validar");
        _bloomTaxonomy[5].add("criticar");
        _bloomTaxonomy[5].add("detectar");
        _bloomTaxonomy[5].add("experimentar");
        _bloomTaxonomy[5].add("juzgar");
        _bloomTaxonomy[5].add("monitorear");
        _bloomTaxonomy[5].add("probar");
        _bloomTaxonomy[5].add("revisar");
        _bloomTaxonomy[5].add("unir");
    ...
    public static int CategorizeSingle(String input) {
        ...
        int _output = 6;
            ...
            for (i = 1; i < _bloomTaxonomy.length; i++) {
                for (int j = 0; j < _bloomTaxonomy[i].size(); j++) {
                    if (input.equalsIgnoreCase(VerbsStemmer.Stem(_bloomTaxonomy[i].get(j)))) {
                        _output = i;
                        found = true;
                        break;
                    }
        ...
        public static String CategorizeSingleGetVerb(String input) {
        ...
        String _output = "";
            ...
            for (i = 1; i < _bloomTaxonomy.length; i++) {
                for (int j = 0; j < _bloomTaxonomy[i].size(); j++) {
                    if (input.equalsIgnoreCase(VerbsStemmer.Stem(_bloomTaxonomy[i].get(j)))) {
                        _output = _bloomTaxonomy[i].get(j);
                        found = true;
                        break;
                    }
                }
